...
public class FolderUploadDifferentFileExtensionsTest {
    ...
    public void step04_upload_different_file_extentions_in_folder(){
        test.folderUploadDifferentFileExtensions.upload_different_file_extentions_in_folder();
