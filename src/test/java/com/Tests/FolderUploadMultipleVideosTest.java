...
public class FolderUploadMultipleVideosTest {
    ...
    public void step05_upload_multiple_videos_in_folder(){
        test.folderUploadMultipleVideos.folder_upload_multiple_videos();
