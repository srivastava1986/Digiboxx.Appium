...
public class FolderUploadMultipleImagesTest {
    ...
    public void step04_upload_multiple_images_in_folder() {
        test.folderUploadMultipleImages.folder_upload_mutilple_images();
    }
